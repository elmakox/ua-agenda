            ...
            <div class="page-title-box d-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Edit aspiration</li>
                    </ol>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            <input type="text" id="title" name="title" class="form-control form-control-lg" placeholder="Title of the project" value="{{ $aspiration->title }}" required>
                        </div>
                        <div class="form-group">
                            <input type="hidden" name="body">
                            <textarea name="body" id="body" rows="6" class="form-control">{{ $aspiration->body }}</textarea>
                        </div>
                        <hr>
                        <label >Goals</label>
                        <div class="clearfix">
                            <table class="table table-bordered" id="goalsTable" data-count="{{ $aspiration->goals ? count($aspiration->goals) : 0 }}">
                                <thead>
                                    <tr>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <img id="holder" class="img-fluid rounded my-2 w-100" src="{{ $aspiration->image ? $aspiration->image_url() : '' }}">
                            <div class="input-group">
                                <input type="text" value="{{ $aspiration->image }}" name="image" id="thumbnail" class="form-control">
