...
@section('title', 'Create Progress - UA Agenda 2063')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            <input type="text" id="title" name="title" class="form-control form-control-lg @error('title') is-invalid @enderror" placeholder="Title of the progress" value="{{ old('title') }}" required>
                            @error('title')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="progress_date" class="form-control" name="progress_date" value="{{ old('progress_date') }}">
                        </div>
                        <div class="form-group">
